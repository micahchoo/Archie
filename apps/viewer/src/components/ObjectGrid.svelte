...
<style>
  ...
  h1 { font-family: var(--font-display); font-weight: 800; font-size: 3rem; line-height: 1.05; margin: var(--space-2) 0 var(--space-3); color: var(--ink-canvas-primary); text-shadow: var(--text-shadow-hero); }
  ...
  .object {
    ...
    border: var(--border-pixel) solid var(--border-canvas-emphasis); border-radius: 0; overflow: hidden;
    box-shadow: var(--shadow-pixel);
    transition: background 160ms ease, border-color 160ms ease, transform 160ms ease, box-shadow 160ms ease;
  }
  .object:hover { background: var(--surface-canvas-overlay); border-color: var(--accent); transform: translate(-2px, -2px); box-shadow: var(--shadow-pixel-strong); }
  ...
  .plate { display: block; width: 100%; aspect-ratio: 4 / 3; background-color: var(--surface-canvas); object-fit: contain; border-bottom: var(--border-pixel) solid var(--border-canvas-emphasis); }
  ...
  .label { font-family: var(--font-display); font-size: 1.6rem; font-weight: 800; line-height: 1.1; color: var(--ink-canvas-primary); }
  .count { font-family: var(--font-mono); font-size: 0.72rem; letter-spacing: 0.1em; text-transform: uppercase; color: var(--accent-2); }

  /* Empty state on the dark table (orphan gate §39) */
  .empty { max-width: 60rem; margin: 0 auto; font-family: var(--font-body); font-size: 1.125rem; line-height: 1.6; color: var(--ink-canvas-secondary); padding: var(--space-6); border: var(--border-pixel) dashed var(--border-canvas-emphasis); border-radius: 0; }
</style>
