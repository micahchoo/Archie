...
export const atlasObjects = [
  { id: asObjectId("ex-atlas.o1"), source: page(166), label: "North America", width: 2550, height: 3301 },
  { id: asObjectId("ex-atlas.o2"), source: page(176), label: "Western South America", width: 2550, height: 3301 },
  { id: asObjectId("ex-atlas.o3"), source: page(184), label: "The Caucasus", width: 2550, height: 3301 },
  { id: asObjectId("ex-atlas.o4"), source: page(190), label: "Western Africa", width: 2550, height: 3301 },
  { id: asObjectId("ex-atlas.o5"), source: page(196), label: "Siberia", width: 2550, height: 3301 },
  { id: asObjectId("ex-atlas.o6"), source: page(202), label: "The Himalaya", width: 2550, height: 3301 },
  { id: asObjectId("ex-atlas.o7"), source: page(208), label: "South-East Asia", width: 2550, height: 3301 },
  { id: asObjectId("ex-atlas.o8"), source: page(214), label: "Australia", width: 2550, height: 3301 },
];
...
export const atlasNotes: AtlasNote[] = [
  ...
  { objectId: "ex-atlas.o1", region: [170, 310, 280, 220], reading: "linguist",
  ...
  { objectId: "ex-atlas.o1", region: [170, 310, 280, 220], reading: "community",
  ...
  { objectId: "ex-atlas.o2", region: [740, 470, 280, 280],
  ...
  { objectId: "ex-atlas.o2", region: [740, 470, 280, 280], reading: "linguist",
  ...
  { objectId: "ex-atlas.o2", region: [740, 470, 280, 280], reading: "community",
  ...
  { objectId: "ex-atlas.o3", region: [440, 720, 320, 290], reading: "community",
  ...
  { objectId: "ex-atlas.o4", region: [300, 540, 280, 250],
  ...
  { objectId: "ex-atlas.o4", region: [300, 540, 280, 250], reading: "linguist",
  ...
  { objectId: "ex-atlas.o4", region: [300, 540, 280, 250], reading: "community",
  ...
  { objectId: "ex-atlas.o5", region: [1560, 650, 380, 320], reading: "community",
  ...
  { objectId: "ex-atlas.o6", region: [410, 570, 280, 230], reading: "community",
  ...
  { objectId: "ex-atlas.o7", region: [810, 580, 300, 280],
  ...
  { objectId: "ex-atlas.o7", region: [810, 580, 300, 280], reading: "linguist",
  ...
  { objectId: "ex-atlas.o7", region: [810, 580, 300, 280], reading: "community",
  ...
  { objectId: "ex-atlas.o8", region: [550, 420, 280, 240],
  ...
  { objectId: "ex-atlas.o8", region: [550, 420, 280, 240], reading: "linguist",
  ...
  { objectId: "ex-atlas.o8", region: [550, 420, 280, 240], reading: "community",
  ...
  { objectId: "ex-atlas.o1", region: [230, 1300, 540, 180], // pinned to the vitality LEGEND
