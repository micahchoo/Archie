...
import {
  AnnotationSession, lngLatToPixel, pixelToLngLat,
...
/** The demo Library's canonical baseUrl — every seeded note targets `${BASE}{slug}/canvas/{objId}`,
 *  matching publishLibrary's per-slug grammar. One definition: App.svelte + ingest-flows share it. */
