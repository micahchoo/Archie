...
<style>
  ...
  .dialog {
    ...
    border: var(--border-pixel-bold) solid var(--border-paper-emphasis); border-radius: 0; padding: var(--space-6);
    box-shadow: var(--shadow-pixel-strong);
  }
  .x { position: absolute; top: var(--space-4); right: var(--space-4); cursor: pointer; background: none; border: none; font-family: var(--font-display); font-size: 1.3rem; line-height: 1; color: var(--ink-paper-muted); padding: 0 var(--space-1); }
  ...
  .body { border-top: var(--border-pixel) solid var(--border-paper); }
  ...
  .primary:hover { transform: translate(2px, 2px); box-shadow: var(--shadow-pixel-btn-active); }
</style>
