import{O as S,Q as L,v as A}from"./chunk-YWAGNAIN.js";function I(n,t){if(!t)return{html:"",media:[]};let o=n.find(a=>String(a.id)===t);if(!o)return{html:"",media:[]};let{media:d,text:l}=S(A(o));return{html:L(l),media:d}}var P=`
  .archie-note-card {
