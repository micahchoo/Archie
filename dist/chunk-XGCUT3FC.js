import{N as L,P as S,u as A}from"./chunk-WWCTCNKS.js";function I(n,t){if(!t)return{html:"",media:[]};let o=n.find(a=>String(a.id)===t);if(!o)return{html:"",media:[]};let{media:d,text:c}=L(A(o));return{html:S(c),media:d}}var P=`
  .archie-note-card {
...
`;function M(n,t){return n.nodeType===9?n.body??t.body:n}function $(n,t){if(n.querySelector("style[data-archie-note]"))return;let o=t.createElement("style");o.setAttribute("data-archie-note",""),o.textContent=P,M(n,t).appendChild(o)}var R=Array.from({length:11},(n,t)=>28+t*53%64);function H(n,t){return n.alt?`${t} ${n.kind}: ${n.alt}`:`${t} ${n.kind}`}function x(n,t,o){let d=n.ownerDocument;if(n.textContent="",t.html){let a=d.createElement("div");a.className="archie-note-card__prose",a.innerHTML=t.html,n.appendChild(a)}if(t.media.length===0)return;if(o.size==="card"){let a=d.createElement("div");a.className="archie-note-media",t.media.forEach((i,u)=>{if(o.failed.has(i.url)){let r=d.createElement("span");r.className="tile-failed",r.textContent="Couldn't load",a.appendChild(r);return}let e=d.createElement("button");e.type="button",e.className=`tile ${i.kind}`,e.setAttribute("aria-label",H(i,"Open"));let p=()=>{o.failed.add(i.url),x(n,t,o)};if(i.kind==="image"){let r=d.createElement("img");r.src=i.url,r.alt="",r.loading="lazy",r.addEventListener("error",p),e.appendChild(r)}else if(i.kind==="video"){let r=d.createElement("video");r.src=i.url,r.muted=!0,r.preload="metadata",r.tabIndex=-1,r.addEventListener("error",p);let s=d.createElement("span");s.className="badge",s.setAttribute("aria-hidden","true"),s.textContent="\u25B6",e.append(r,s)}else{let r=d.createElement("span");r.className="wave",r.setAttribute("aria-hidden","true");for(let m of R){let l=d.createElement("i");l.style.height=`${m}%`,r.appendChild(l)}let s=d.createElement("span");s.className="badge",s.setAttribute("aria-hidden","true"),s.textContent="\u266A",e.append(r,s)}e.addEventListener("click",()=>o.onmedia?.(u)),a.appendChild(e)}),n.appendChild(a);return}let c=d.createElement("div");c.className="archie-note-figures";for(let a of t.media){let i=d.createElement("figure");if(o.failed.has(a.url)){let e=d.createElement("p");e.className="figure-failed",e.textContent=a.alt?`Couldn't load this ${a.kind}: ${a.alt}`:`Couldn't load this ${a.kind}.`,i.appendChild(e),c.appendChild(i);continue}let u=()=>{o.failed.add(a.url),x(n,t,o)};if(a.kind==="image"){let e=d.createElement("img");e.src=a.url,e.alt=a.alt??"",e.addEventListener("error",u),i.appendChild(e)}else{let e=d.createElement(a.kind==="video"?"video":"audio");e.src=a.url,e.controls=!0,a.alt&&e.setAttribute("aria-label",a.alt),e.addEventListener("error",u),i.appendChild(e)}if(a.alt){let e=d.createElement("figcaption");e.textContent=a.alt,i.appendChild(e)}c.appendChild(i)}n.appendChild(c)}function z(n){return[...n.querySelectorAll('a[href], button:not([disabled]), input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])')].filter(o=>o.getClientRects().length>0)}function B(n){let t=n.ownerDocument,o=n.getRootNode();$(o,t);let d=new Set,c={html:"",media:[]},a=!1,i=t.createElement("div");i.className="archie-note-card",i.setAttribute("role","complementary"),i.setAttribute("aria-label","Note"),i.hidden=!0;let u=t.createElement("div");u.className="archie-note-card__actions";let e=t.createElement("button");e.type="button",e.className="archie-note-card__expand",e.setAttribute("aria-label","Expand note to a reading sheet"),e.title="Expand note to a reading sheet",e.textContent="\u2922",e.hidden=!0;let p=t.createElement("button");p.type="button",p.className="archie-note-card__dismiss",p.setAttribute("aria-label","Close note"),p.textContent="\xD7",p.addEventListener("click",()=>E()),u.append(e,p);let r=t.createElement("div");r.className="archie-note-card__body",i.append(u,r),n.appendChild(i);let s=t.createElement("div");s.className="archie-note-sheet-layer",s.hidden=!0;let m=t.createElement("div");m.className="archie-note-sheet-scrim",m.addEventListener("click",()=>b());let l=t.createElement("div");l.className="archie-note-sheet",l.setAttribute("role","dialog"),l.setAttribute("aria-modal","true"),l.setAttribute("aria-label","Note"),l.tabIndex=-1;let y=t.createElement("div");y.className="archie-note-sheet__head";let f=t.createElement("button");f.type="button",f.setAttribute("aria-label","Close reading sheet"),f.textContent="\xD7",f.addEventListener("click",()=>b()),y.appendChild(f);let v=t.createElement("div");v.className="archie-note-sheet__body",l.append(y,v),s.append(m,l),M(o,t).appendChild(s),s.addEventListener("keydown",w=>{let h=w;if(h.key==="Escape"){h.preventDefault(),h.stopPropagation(),b();return}if(h.key!=="Tab")return;let g=z(l);if(g.length===0){h.preventDefault();return}let N=g[0],_=g[g.length-1],C=o.activeElement??t.activeElement;h.shiftKey&&(C===N||C===l)?(h.preventDefault(),_.focus()):!h.shiftKey&&C===_&&(h.preventDefault(),N.focus())});function k(){a||!c.html&&c.media.length===0||(a=!0,x(v,c,{size:"sheet",failed:d,onmedia:void 0}),s.hidden=!1,i.hidden=!0,(z(l)[0]??l).focus())}function b(){a&&(a=!1,s.hidden=!0,v.textContent="",i.hidden=!1,e.focus())}e.addEventListener("click",()=>k());function T(w,h){if(c=I(w,h),!c.html&&c.media.length===0){E();return}x(r,c,{size:"card",failed:d,onmedia:()=>k()}),e.hidden=!1,i.hidden=!1}function E(){a&&b(),i.hidden=!0,e.hidden=!0,r.textContent="",c={html:"",media:[]}}function D(){i.remove(),s.remove()}return{showNote:T,hide:E,destroy:D}}export{I as a,B as b};
