...
const mapExhibit: Exhibit = { id: "ex", slug: "geo", title: "Geo", objects: [{ id: "m1", source: ts.template, label: "World map", tileSource: ts }] };
...
describe("Map tileSource round-trip through the manifest", () => {
  ...
  it("is byte-stable for a non-Map object (no archie:tileSource key)", () => {
    const m = toManifest({ id: "e", slug: "img", title: "Img", objects: [{ id: "o1", source: "https://x/a.jpg", label: "img" }] });
