...
export const LICENSES: readonly LicenseOption[] = [
  ...
  { uri: "https://creativecommons.org/publicdomain/zero/1.0/", label: "CC0 1.0 — Public Domain Dedication" },
  { uri: "https://creativecommons.org/publicdomain/mark/1.0/", label: "Public Domain Mark 1.0" },
  { uri: "https://creativecommons.org/licenses/by/4.0/", label: "CC BY 4.0" },
  { uri: "https://creativecommons.org/licenses/by-sa/4.0/", label: "CC BY-SA 4.0" },
  { uri: "https://creativecommons.org/licenses/by-nc/4.0/", label: "CC BY-NC 4.0" },
  { uri: "https://creativecommons.org/licenses/by-nc-sa/4.0/", label: "CC BY-NC-SA 4.0" },
  { uri: "https://creativecommons.org/licenses/by-nd/4.0/", label: "CC BY-ND 4.0" },
