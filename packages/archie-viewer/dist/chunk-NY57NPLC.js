import{a as L,b as v}from"./chunk-4SLSEVNN.js";import{R as M,T as D,x as z}from"./chunk-B34JJRIT.js";function $(a,r){if(!r)return{html:"",media:[]};let t=a.find(e=>String(e.id)===r);if(!t)return{html:"",media:[]};let{media:o,text:m}=M(z(t));return{html:D(m),media:o}}var O=`
  .archie-note-card {
