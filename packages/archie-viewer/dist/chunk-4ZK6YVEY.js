import{P as S,R as L,x as A}from"./chunk-WJJ36BU4.js";function I(n,t){if(!t)return{html:"",media:[]};let o=n.find(a=>String(a.id)===t);if(!o)return{html:"",media:[]};let{media:d,text:l}=S(A(o));return{html:L(l),media:d}}var P=`
  .archie-note-card {
