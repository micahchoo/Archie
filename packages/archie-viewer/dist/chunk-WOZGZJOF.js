import{N as S,P as L,u as A}from"./chunk-KYHIQCSO.js";function I(n,t){if(!t)return{html:"",media:[]};let o=n.find(a=>String(a.id)===t);if(!o)return{html:"",media:[]};let{media:d,text:l}=S(A(o));return{html:L(l),media:d}}var P=`
  .archie-note-card {
