...
Archie turns your media — manuscript scans, maps, audio, video — into an
interactive website that visitors explore in their browser. You annotate the
media, then **publish**: Archie writes a folder of plain files you can host
anywhere. There is no server to run and no database to maintain.

Here is a finished exhibit, published and live — the Voynich manuscript:
...
visitors get is the **Viewer**. They are the same exhibit, two ends of one loop.
