...
**Commits:** landed in `4e8a353` (2026-07-05, "feat: add openArchieLibrary canonical untrusted-zip
open module", ISSUES.md Issue 5) — the three focused commits this ledger anticipated (new module;
studio gap fix; viewer/archie-viewer migration) went out together in that one. The 2026-07-19 cap
rescale below landed separately at `6551bfc` (scale/zip-stream-caps).
...
**Done 2026-07-05**, committed in `4e8a353`: zero losing call sites, all four packages' full test
...
## Cap rescale 2026-07-19 (scale/zip-stream-caps, landed `6551bfc`, merged with review)
