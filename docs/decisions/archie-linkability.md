...
| Q-3 | A self-contained export ships `<archie-viewer>`, never the Astro viewer app | 2026-07-26 | - | PROPOSED, not yet user-gated (ledgers/EXPLORE-studio-folder-export-settings-2026-07-26.md §2). apps/viewer bakes its routes at build time from public/published/ |
<!-- DECISIONS_INDEX_END -->
