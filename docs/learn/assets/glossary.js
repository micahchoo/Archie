...
window.ARCHIE_GLOSSARY = {
  ...
  example:   { term: "Example",   def: "A read-only template exhibit you can explore. Edits aren’t saved unless you “Keep a copy”, which turns it into an exhibit you own." },
